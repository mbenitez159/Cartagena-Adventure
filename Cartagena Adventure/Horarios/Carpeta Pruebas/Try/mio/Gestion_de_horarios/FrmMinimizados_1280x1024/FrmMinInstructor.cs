...
{
    public partial class FrmMinInstructor : Form
    {
        FrmInstructor_1280x1024 instructor;
        FrmPrincipal_1280x1024 principal;

        public FrmMinInstructor(FrmInstructor_1280x1024 instructor, FrmPrincipal_1280x1024 principal)
        {
            InitializeComponent();
        ...
        private void FrmMinInstructor_MouseClick(object sender, MouseEventArgs e)
        {
            click();
        }
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            ...
            {
                instructor.Close();
                principal.BtnInstructor.Enabled = true;
            }

            principal.EspacioMin[instructor.posM] = "Desocupado";
        }
        ...
        private void FrmMinInstructor_MouseLeave(object sender, EventArgs e)
        {
            this.BackColor = Color.FromArgb(4, 123, 117);
        }

        private void FrmMinInstructor_MouseMove(object sender, MouseEventArgs e)
        {
